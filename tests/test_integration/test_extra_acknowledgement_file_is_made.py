"""
Integration test that runs extraction for an XML file, and ensures that all the
files that are expected are made.
"""
...
class TestExtractWorker(TestGeneric):
    ...
    def test_extraction_of_non_extracted(self):
        ...
        self.assertTrue(
            ...
            'Standard queue should have at least {0:d}'
        ...
        self.assertTrue(
            ...
            'This should be NOT_EXTRACTED_BEFORE, but is in fact: {0}'
        ...
        for path in self.expected_paths:
            ...
            self.assertTrue(
                os.path.exists(os.path.join(path, 'acknowledgements.txt')),
                'Acknowledgements file not created: {0}'.format(path)
            )
